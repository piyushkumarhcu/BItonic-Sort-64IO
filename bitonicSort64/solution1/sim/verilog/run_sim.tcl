...
if {[file isfile bitonicSort64.autotvin.dat]} {
	file delete -force bitonicSort64.autotvin.dat
}

if {[file isfile bitonicSort64.autotvout.dat]} {
	file delete -force bitonicSort64.autotvout.dat
}
